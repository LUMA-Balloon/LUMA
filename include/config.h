...
struct Config {
  ...
  const char* telemetryFilePrefix = "telemetry/LUMA-Data-";
  const char* secondaryTelemetryFilePrefix = "extra/LUMA-Extra-";
  const char* errorMessageFilePrefix = "errors/LUMA-Errors-";
